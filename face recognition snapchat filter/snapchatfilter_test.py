...
frame=cv2.imread('C:/Users/BHAWNAVEEN/Downloads/Week 4 - Face Recognition Assignment/Test/Before.jpg')
...
while True:
    ...
    with open('C:/Users/BHAWNAVEEN/Documents/'+'test_output.csv', 'w', newline='') as file:
